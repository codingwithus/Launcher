...
final class Utilities {
	...
	private static void initStatics(Context context) {
		 ...
		 * BlurMaskFilter��EmbossMaskFilter ��ʱȥ��������� modify by author
		 */
		/*
		 * sGlowColorPressedPaint.setColor(0xffffc300);
		 * sGlowColorPressedPaint.setMaskFilter
		 * (TableMaskFilter.CreateClipTable(0, 30));
		 * sGlowColorFocusedPaint.setColor(0xffff8e00);
		 * sGlowColorFocusedPaint.setMaskFilter
		 * (TableMaskFilter.CreateClipTable(0, 30));
		 */
