...
public class BubbleTextView extends TextView {
	...
	protected boolean setFrame(int left, int top, int right, int bottom) {
		 ...
		 * ��ͨ��getRight()\getLeft()\getBottom()\getTop()������ modify by author
		 */
	...
	public void draw(Canvas canvas) {
		...
		if (background != null) {
			/**
			 * mScrollX\mScrollY�������� ��ͨ��getScrollX()\getScrollY()������
			 * modify by author
			 */
			...
			if (mBackgroundSizeChanged) {
				/**
				 * mRight\mLeft\mBottom\mTop��������
				 * ��ͨ��getRight()\getLeft()\getBottom()\getTop()������ modify
				 * by author
				 */
		 ...
		 * ��ͨ��getScrollX()\
		 * getScrollY()\getRight()\getLeft()\getBottom()\getTop()������ modify
		 * by author
		 */
