...
class SymmetricalLinearTween {
	 ...
	 *            callbacks
	 */
	public SymmetricalLinearTween(boolean initial, int duration,
	 ...
	 * 
	 * @param direction
	 *            If direction is true, the value goes towards 1.0f. If
	 *            direction is false, the value goes towards 0.0f.
	 */
	 ...
	 *            direction is false, the value goes towards 0.0f.
	 * @param baseTime
	 *            The time to use as zero for this animation, in the
